 ...
 *
 * Both routes render this: `/` in Georgian and `/en/` in English. Passing the
 * locale in as a prop rather than picking one on the client is what lets each
 * URL prerender in its own language — a shared link opens correct, with no
 * flash of the other language and nothing for a crawler to miss.
 */
export default function Page({ locale }: { locale: Locale }) {
  return (
    <LocaleProvider locale={locale}>
      {/* See app/layout.tsx: this is where the English page stops being Georgian. */}
      <div lang={locale}>
